...
if __name__ == "__main__":
    ...
    parameters = dict(
        x21=('categorical', [1, 2, 3], 1), x22=('categorical', [1, 2, 3], 2), x23=('categorical', [1, 2, 3], 2),
        x24=('categorical', [1, 2, 3], 2), x25=('categorical', [1, 2, 3], 1), x26=('categorical', [1, 2, 3], 1),
        x31=('categorical', [1, 2, 3], 1), x32=('categorical', [1, 2, 3], 2), x33=('categorical', [1, 2, 3], 2),
        x34=('categorical', [1, 2, 3], 2), x35=('categorical', [1, 2, 3], 2), x36=('categorical', [1, 2, 3], 2),
        x41=('categorical', [1, 2, 3], 2), x42=('categorical', [1, 2, 3], 2), x43=('categorical', [1, 2, 3], 2),
        x44=('categorical', [1, 2, 3], 2), x45=('categorical', [1, 2, 3], 2), x46=('categorical', [1, 2, 3], 2),
        x51=('categorical', [1, 2, 3], 2), x52=('categorical', [1, 2, 3], 2), x53=('categorical', [1, 2, 3], 2),
        x54=('categorical', [1, 2, 3], 3), x55=('categorical', [1, 2, 3], 3), x56=('categorical', [1, 2, 3], 1),
        x61=('categorical', [1, 2, 3], 3), x62=('categorical', [1, 2, 3], 2), x63=('categorical', [1, 2, 3], 2),
        x64=('categorical', [1, 2, 3], 3), x65=('categorical', [1, 2, 3], 3), x66=('categorical', [1, 2, 3], 3),
        x71=('categorical', [1, 2, 3], 3), x72=('categorical', [1, 2, 3], 3), x73=('categorical', [1, 2, 3], 3),
        x74=('categorical', [1, 2, 3], 3), x75=('categorical', [1, 2, 3], 3), x76=('categorical', [1, 2, 3], 3),
    )

    opt = pysmac.SMAC_optimizer()
    value, parameters = opt.minimize(avg_waiting_time, 100, parameters)

    print(('Lowest function val ue found: %f' % value))
